lazy_static::lazy_static! {
    pub static ref T: std::collections::HashMap<&'static str, &'static str> =
        [
            ...
            ("Remove", "删除"),
            ("Refresh random password", "刷新临时密码"),
            ("Set your own password", "设置密码"),
            ("Enable keyboard/mouse", "允许控制键盘/鼠标"),
            ("Enable clipboard", "允许远程拷贝粘贴"),
            ("Enable file transfer", "允许传输文件"),
            ("Enable TCP tunneling", "允许创建 TCP 隧道"),
            ("IP Whitelisting", "IP 白名单"),
            ("ID/Relay Server", "信息化配置"),
            ("Import server config", "导入信息化配置"),
            ("Export Server Config", "导出信息化配置"),
            ("Import server configuration successfully", "导入信息化配置信息成功"),
            ("Export server configuration successfully", "导出信息化配置信息成功"),
            ("Invalid server configuration", "信息化配置无效，请修改后重新复制配置信息到剪贴板，然后点击此按钮"),
            ("Clipboard is empty", "拷贝信息化到剪贴板后点击此按钮，可以自动导入配置"),
            ("Stop service", "停止服务"),
            ("Change ID", "更改 ID"),
            ("Your new ID", "你的新 ID"),
            ...
            ("Invalid IP", "无效 IP"),
            ("Invalid format", "无效格式"),
            ("server_not_support", "无效操作，请联系管理员"),
            ("Not available", "不可用"),
            ...
            ("Lock after session end", "断开连接锁定远程设备"),
            ("Insert", "输入"),
            ("Insert Lock", "锁定远程设备"),
            ("Refresh", "刷新画面"),
            ("ID does not exist", "设备不存在"),
            ("Failed to connect to rendezvous server", "连接云端服务失败"),
            ("Please try later", "请稍后再试"),
            ("Remote desktop is offline", "设备处于离线状态"),
            ("Key mismatch", "密钥无效，请联系管理员"),
            ("Timeout", "连接超时"),
            ("Failed to connect to relay server", "Fail to Relay"),
            ("Failed to connect via rendezvous server", "Fail to REG"),
            ("Failed to connect via relay server", "Failed to connect via relay"),
            ...
            ("setup_server_tip", "基于RustDes开源项目，由灰太狼叔叔运营！"),
            ...
            ("Always connect via relay", "强制中继连接"),
            ...
            ("remote_restarting_tip", "远程设备正在重启, 请等待, 并在一段时间后重新连接"),
            ("Copied", "已复制"),
            ...
            ("Show Toolbar", "显示工具栏"),
            ("Hide Toolbar", "隐藏工具栏"),
            ("Direct Connection", "P2P连接"),
            ("Relay Connection", "Relay连接"),
            ...
            ("Disconnected", "会话已结束"),
            ("Other", "其他"),
            ("Confirm before closing multiple tabs", "关闭多个设备组页时向您确认"),
            ...
            ("Maximize", "最大化"),
            ("Your Device", "你的设备"),
            ("empty_recent_tip", "无历史会话！"),
            ("empty_favorite_tip", "还没有收藏的被控端！"),
            ("empty_lan_tip", "未发现任何被控端！"),
            ("empty_address_book_tip", "目前云端设备内无被控端"),
            ("eg: admin", "例如：admin"),
            ("Empty Username", "空用户名"),
            ("Empty Password", "空密码"),
            ("Me", "我"),
            ...
            ("verify_rustdesk_password_tip", "验证被控密码"),
            ...
            ("synced_peer_readded_tip", "最近会话中存在的设备将会被重新同步到云端。"),
            ("Change Color", "更改颜色"),
            ("Primary Color", "基本色"),
            ("HSV Color", "HSV 色"),
            ...
            ("Send clipboard keystrokes", "插入 Ctrl + V"),
            ("network_error_tip", "请检查网络连接，然后点击再试"),
            ("Unlock with PIN", "使用PIN锁定安全设置"),
